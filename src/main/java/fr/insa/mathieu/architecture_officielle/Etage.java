...
public class Etage {
    ...
    private ArrayList<Mur> liste_mur_facade;//TODO a modifier avec liste Facade
...
//FUNCTIONS
    public void add(Mur mur){//TODO a
        this.liste_mur_facade.add(mur);
    }
    /*
...
// GET
    ...
    public ArrayList<Mur> getListe_mur_facade() {//TODO possibilité de mettre dans l'ID Manager ses attributs
