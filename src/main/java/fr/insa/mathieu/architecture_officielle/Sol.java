...
*/
    ...
    public Sol(Coin supg, Coin supd, Coin infg, Coin infd) {
...
*/
    ...
    Sol sol = new Sol(supg,supd,infg,infd); // Création de mon sol
    Plafond plafond = new Plafond(supg,supd,infg,infd);
